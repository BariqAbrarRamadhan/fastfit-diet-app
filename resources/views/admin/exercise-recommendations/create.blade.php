...
@section('title', 'Tambah Rekomendasi Olahraga')
...
<div class="p-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Tambah Rekomendasi Olahraga</h1>
                    <p class="text-gray-600">Buat rekomendasi olahraga baru untuk pengguna</p>
                </div>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <div class="p-6">
            <form action="{{ route('admin.exercise-recommendations.store') }}" method="POST" class="space-y-6">
                @csrf
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   placeholder="Contoh: Push Up, Yoga, Lari"
                                   required>
                            @error('name')
                        ...
                        <div>
                            ...
                            <select id="goal" 
                                ...
                                @foreach($goals as $key => $value)
                                    <option value="{{ $key }}" {{ old('goal') == $key ? 'selected' : '' }}>{{ $value }}</option>
                                @endforeach
                            </select>
                            @error('goal')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                ...
                <div class="border-t border-gray-200 pt-6">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" 
                               ...
                               value="{{ old('calories_burned_per_hour') }}"
                               min="0"
                               max="2000"
                    ...
                    <div>
                        ...
                        <textarea id="instructions" 
                                  ...
                                  placeholder="Jelaskan langkah-langkah melakukan olahraga ini...">{{ old('instructions') }}</textarea>
                        @error('instructions')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const frequency = document.querySelector('input[name="frequency_per_week"]');
        const caloriesPerHour = document.querySelector('input[name="calories_burned_per_hour"]');
